...
public class CategoryAdapter extends BaseAdapter
{
    ...
    public CategoryAdapter(Activity activity, List<Category> listImage, int height)
    {
        ...
        desireHeight = height;
        options = new DisplayImageOptions.Builder().cacheInMemory(true).displayer(new RoundedBitmapDisplayer((int) (5 * StaticFunction.getDensity(activity)))).showImageForEmptyUri(R.color.white).showImageOnLoading(R.color.white).cacheOnDisc(true).build();
    }
